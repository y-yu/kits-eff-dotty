...
object Writer {
  def tell[W](value: W): Eff[[A] =>> Writer[W, A], Unit] =
    Eff[[A] =>> Writer[W, A], Unit](Put(value))

  def runVec[R[_], W, A](eff: Eff[[A] =>> Writer[W, A] | R[A], A]): Eff[R, (Vector[W], A)] =
    Eff.handleRelayS[[X] =>> Writer[W, X], R, Vector[W], A, (Vector[W], A)](Vector.empty[W], eff)(
      new Eff.HandlerS[[X] =>> Writer[W, X], R, Vector[W], A, (Vector[W], A)] {
  ...
  def runList[R[_], W, A](eff: Eff[[A] =>> Writer[W, A] | R[A], A]): Eff[R, (List[W], A)] =
    Eff.handleRelay[[X] =>> Writer[W, X], R, A, (List[W], A)](eff)(new Eff.Handler[[A] =>> Writer[W, A], R, A, (List[W], A)] {
